...
BX.ready(function(){
	...
	//Выделяем/Отменяем все сообщения
	$("#check_all").click(function () {
			if($("#selectall").hasClass('yes'))
			{
				$("#selectall").removeClass("yes");
				$("#selectall").children().removeClass("checked");
			}
			else
			{
				$("#selectall").addClass("yes");
				$("#selectall").children().addClass("checked");
			}
	});
