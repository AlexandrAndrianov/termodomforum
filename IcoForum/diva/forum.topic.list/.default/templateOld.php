...
<!--		<div class="forum-block raised-corners">-->
				...
				?>
							...
							<li <?if(true):?>ondblclick="defaultico(this);"<?endif?> class="<?=($res['TopicStatus'] == 'NEW'? 'has-message' : ' ')?>">	
										<div class="forum-icon">
											<?if(empty($arField['XML_ID'])):?>
													<i ondblclick="selectico(this, event);" id="<?=$res["ID"]?>" class="fa fa-<?
													$title = ""; $class = "";
											...
											<?if($arField['PROPERTY_CODE'] === 'PROP_TEMES_ICO'):?>
												<i id="<?=$res['ID']?>" class="<?=$arField['VALUE']?>" <?if(true):?>ondblclick="selectico(this, event);"<?endif?>></i>
											<?endif?>
											
											<?if($arField['PROPERTY_CODE'] === 'PROP_TEMES_IMG'):?>
												<img id="<?=$res['ID']?>" src="<?=$arField['VALUE']?>" <?if(true):?>ondblclick="selectico(this, event);"<?endif?>></i>
											<?endif?>
										</div>
		...
		<?else:?>
			...
			<? if(CModule::IncludeModule("iblock"))
				{ 
					...
					{
						if($arPSField['PROPERTY_CODE'] === 'PROP_TEMES_ICO')
						{
